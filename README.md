...
Custom GATT service แยกจาก HID (ไม่บังคับเข้ารหัส ใครที่ต่อ BLE เข้าบอร์ดได้จะอ่าน/เขียนข้อความได้). ข้อความเก็บในแรมได้ 1 ก้อน ≤ 4096 ไบต์ และถูกล้างเองหลัง 60 วินาที. ถ้า Windows ไม่เห็น service ใหม่ให้ลบอุปกรณ์แล้ว pair ใหม่ (Windows แคช GATT)
