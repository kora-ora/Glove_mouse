...
| **AD0** | **3.3V** | ต้องย้ายจาก GND มาต่อ 3.3V เพื่อให้ MPU6050 เป็น `0x69` และไม่ชนกับ DS3231 ที่ `0x68` |
...
> สำคัญ: DS3231 ใช้ I2C address `0x68` เช่นเดียวกับ MPU6050 ค่าเดิม จึงต้องต่อ **AD0 ของ MPU6050 → 3.3V** ให้ MPU6050 เป็น `0x69` ตามตารางด้านบน มิฉะนั้นจะอ่านอุปกรณ์ทั้งสองพร้อมกันไม่ได้
